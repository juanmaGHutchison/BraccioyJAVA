...
/*  
Posibles valores en grados de cada motor.
  MOTOR   DESDE(º)    HASTA(º)
  M1:     90        180
  M2:   15        165Braccio
  M3:   0       180
  M4:   0       180
  M5:   0       180
  M6:   10        73      -> 10 = MANOS ABIERTAS; 73 = MANOS CERRADAS
*/
...
public:
  ...
  _Braccio(int = 90, int = 90, int = 90, int = 90, int = 90,int = 10);
